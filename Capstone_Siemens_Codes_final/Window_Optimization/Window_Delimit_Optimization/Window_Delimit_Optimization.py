...
from helper_functions.window_extraction import calculate_window_values, calculate_window_data, process_sensor_data
from helper_functions.slope_calculation import calculate_column_means, calculate_slope, difference_of_slopes
from helper_functions.window_visualization import plot_singletest_with_windows, plot_singletest_without_newWindows
...
plt.scatter(min_abs_diff_slopes_cal_key, diff_slopes_result_A_cal[min_abs_diff_slopes_cal_key]['diff_slopes_cal'],
            color='red', zorder=5, label='Optimal Delimit (Min)')
plt.scatter(calDelimit_A, diff_slopes_result_A_cal[calDelimit_A]['diff_slopes_cal'],
            color='green', zorder=5, label='Current Delimit')
...
plt.annotate(f'{min_abs_diff_slopes_cal_key}',
             (min_abs_diff_slopes_cal_key, diff_slopes_result_A_cal[min_abs_diff_slopes_cal_key]['diff_slopes_cal']),
             textcoords="offset points", xytext=(0,10), ha='center', color='red', fontsize=16)
plt.annotate(f'{calDelimit_A}',
             (calDelimit_A, diff_slopes_result_A_cal[calDelimit_A]['diff_slopes_cal']),
             textcoords="offset points", xytext=(0,10), ha='left', color='green', fontsize=16)
plt.annotate(f'{min_abs_diff_slopes_sample_key}',
             (min_abs_diff_slopes_sample_key, diff_slopes_result_A_sample[min_abs_diff_slopes_sample_key]['diff_slopes_sample']),
             textcoords="offset points", xytext=(0,10), ha='center', color='red', fontsize=16)
plt.annotate(f'{sampleDelimit_A}',
             (sampleDelimit_A, diff_slopes_result_A_sample[sampleDelimit_A]['diff_slopes_sample']),
             textcoords="offset points", xytext=(0,10), ha='right', color='green', fontsize=16)

# Adding title and labels
plt.title('Difference of Slopes for Calibration and Sample Windows of Sensor A', fontsize=14)

plt.xlabel('Delimit Value', fontsize=14)  # Adjusted x-axis label fontsize
plt.ylabel('Difference of Slopes', fontsize=14)  # Adjusted y-axis label fontsize
...
randomTestID=A2_Merged['TestID'].sample(1, random_state=599).values[0]
...
# %%
# # Random sample one TestID for sensor A in System 2 without showing new windows
# randomTestID=A2_Merged['TestID'].sample(1,random_state=599).values[0]
# plot_singletest_without_newWindows(A2_Merged,randomTestID,calDelimit=9.6,sampleDelimit=17.2,cal_window_size=cal_window_size_A,sample_window_size=sample_window_size_A)
...
plt.scatter(min_abs_diff_slopes_cal_key, diff_slopes_result_B_cal[min_abs_diff_slopes_cal_key]['diff_slopes_cal'],
            color='red', zorder=5, label='Optimal Cal Delimit (Min)')
plt.scatter(calDelimit_B, diff_slopes_result_B_cal[calDelimit_B]['diff_slopes_cal'],
            color='green', zorder=5, label='Current Cal Delimit')
# Annotate the points with minimum values
plt.annotate(f'{round(min_abs_diff_slopes_cal_key)}',
             (min_abs_diff_slopes_cal_key, diff_slopes_result_B_cal[min_abs_diff_slopes_cal_key]['diff_slopes_cal']),
             textcoords="offset points", xytext=(0,-30), ha='center', color='red', fontsize = 16)
plt.annotate(f'{calDelimit_B}',
             (calDelimit_B, diff_slopes_result_B_cal[calDelimit_B]['diff_slopes_cal']),
             textcoords="offset points", xytext=(10,20), ha='center', color='green', fontsize = 16)

# Adding title and labels
plt.title('Difference of Slopes for Calibration Window of Sensor B', fontsize=14)
plt.xlabel('Delimit Value',fontsize=14)
plt.ylabel('Difference of Slopes', fontsize=14)
...
# Annotate the points with minimum values
plt.annotate(f'{min_abs_diff_slopes_sample_blood_key}',
             ...
             textcoords="offset points", xytext=(0,10), ha='center', color='red', fontsize = 16)
plt.annotate(f'{sampleDelimit_B_blood}',
             (sampleDelimit_B_blood, diff_slopes_result_B_sample_blood[sampleDelimit_B_blood]['diff_slopes_sample_blood']),
             textcoords="offset points", xytext=(0,10), ha='center', color='green', fontsize = 16)
plt.annotate(f'{min_abs_diff_slopes_sample_aqueous_key}',
             ...
             textcoords="offset points", xytext=(0,10), ha='center', color='red', fontsize = 16)
plt.annotate(f'{sampleDelimit_B_aqueous}',
             (sampleDelimit_B_aqueous, diff_slopes_result_B_sample_aqueous[sampleDelimit_B_aqueous]['diff_slopes_sample_aqueous']),
             textcoords="offset points", xytext=(0,10), ha='center', color='green', fontsize = 16)

# Adding title and labels
plt.title('Difference of Slopes for Sample Windows of Sensor B - Blood / Aqueous', fontsize = 14)
plt.xlabel('Delimit Value', fontsize = 14)
plt.ylabel('Difference of Slopes', fontsize = 14)
